...
<div class="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
    <form class="flex flex-1">
        ...
        <div class="relative flex items-center w-full">
            ...
            <input id="search-field" bind:value={searchField} on:input class="block h-full w-full border-0 bg-transparent py-0 pl-8 pr-0 text-[#667979] focus:ring-0 sm:text-sm placeholder-[#A4A4A4]" placeholder="Search..." type="search" name="search">
            <a href="/">
